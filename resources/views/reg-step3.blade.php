    ...
    <div class="profile">
        <div class="container">
            ...
            <div class="profile-inner">
                <form class="rg-form" method="post" action="{{ route('step3') }}">
                    @csrf
                    ...
                    <input style="margin: 20px 60px" name="password_confirmation" type="password" placeholder="Подтвержение пароля" required>
